...
// Interface defining the structure of a Terneuzen on-call entry
interface TerneuzenOnCallEntry {
  id?: string; // Unique identifier for the on-call entry (optional, generated by the backend)
  groupName: string; // Name of the group this entry belongs to (e.g., "Terneuzen")
...
// Interface defining the structure of a terneuzen contact
...
// Interface for input to create a new Terneuzen on-call entry
...
// Interface for input to update an existing Terneuzen on-call entry
...
// Function to fetch terNeuzen contact information from the backend
const fetchTerneuzenContacts = async () => {
  console.log("Fetching terNeuzen contacts...");
  try {
    ...
    if (result.data) {
      ...
      console.log("Terneuzen contacts fetched:", contacts.value);
    } else {
      console.error("Error fetching terNeuzen contacts:", result.errors);
      throw new Error("Error fetching terNeuzen contacts");
    }
  } catch (error) {
    console.error("Error in fetchTerneuzenContacts:", error);
  }
};
// Function to fetch terNeuzen on-call entries from the backend
const fetchTerneuzenOnCallEntries = async () => {
  console.log("Fetching terNeuzen on-call entries...");
  try {
    ...
    if (result.data) {
      ...
      console.log("Terneuzen on-call entries fetched:", onCallList.value);
    } else {
      console.error("Error fetching terNeuzen on-call entries:", result.errors);
      throw new Error("Error fetching terNeuzen on-call entries");
    }
  } catch (error) {
    console.error("Error in fetchTerneuzenOnCallEntries:", error);
  }
};
// Function to save or update terNeuzen contact information
...
// Function to update the phone number for a Terneuzen on-call entry
...
// Function to generate the terNeuzen on-call calendar for the selected month and year
const generateCalendar = async () => {
  ...
  try {
    ...
    console.error('Error fetching terNeuzen on-call entries:', error);
  }
...
const checkAdmin = async () => {
  try {
    ...
    if (Array.isArray(groups)) {
      isAdmin.value = groups.includes("TerneuzenAdmin"); // Check if the user belongs to the "TerneuzenAdmin" group
    } else {
...
// Function to fetch terNeuzen on-call entries and reload the schedule
...
// Function to save the terNeuzen on-call schedule to the backend
